...
class RatingApiTests(APITestCase):
    ...
    def test_value_out_of_range_rejected(self):
        ...
        self.client.force_authenticate(user=user)
        resp = self.client.put("/api/pink/ratings/rfc1/", {"value": 9}, format="json")
